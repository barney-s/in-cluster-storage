...
*   [Deployment Runbook](runbooks/deploy.md) — Executable step-by-step instructions to build, deploy, verify, and teardown storage subsystems on GKE in Google Cloud project `cnrm-barni-2`. *(Freshest)*
